...
// this.currentQuantity = quantity;
  ...
  watch: {
    wholesalePackageTypeQuantity(type, oldType) {
      ...
      switch (+type) {
        case 2:
          this.basketItemData.type = 'package';
          this.basketItemData.quantity = +this.basketItemData.info.packageSize * this.currentQuantity;
          break;
        case 3:
          this.basketItemData.type = 'box';
          this.basketItemData.quantity = +this.basketItemData.info.boxSize * this.currentQuantity;
          break;
        default:
          this.basketItemData.type = 'goods';
          this.basketItemData.quantity = this.currentQuantity;
      }
